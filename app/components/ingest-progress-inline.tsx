    ...
    <div className="bg-white border border-gray-200 rounded-xl p-6 space-y-4 mb-6">
      ...
      {isCompleted && (
        <div className="text-center space-y-4">
          ...
          <div>
            <p className="font-semibold text-gray-900 text-lg">Ingestion Complete!</p>
            <p className="text-sm text-gray-600 mt-1">
              {status?.documents_count || 0} documents processed successfully
            </p>
          </div>
          <button
            onClick={onDismiss}
      ...
      {isFailed && (
        <div className="text-center space-y-4">
          ...
          <div>
            <p className="font-semibold text-gray-900 text-lg">Ingestion Failed</p>
            <p className="text-sm text-red-600 mt-1">{status?.error || 'Unknown error'}</p>
          </div>
          <button
            onClick={onDismiss}
