              ...
              >
                {behavior === 'appointment' && !calendarId ? (
                  <div className="p-6 bg-amber-50 border border-amber-200 rounded-lg text-center">
                    ...
                    <h3 className="text-sm font-semibold text-amber-900 mb-2">Calendar Connection Required</h3>
                    <p className="text-xs text-amber-700 mb-4">
                      Appointment booking forms are unavailable because Google Calendar is not connected. 
                      Please connect your calendar in the Integrations section above to enable booking forms.
                    </p>
                    <div className="text-xs text-amber-600">
                      <strong>Note:</strong> Form links will become available once calendar is connected.
                    </div>
                  </div>
                ) : (
                <div className="space-y-4">
